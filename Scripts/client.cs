...
function onChallengeRequestRejected( %msg )
{
   ...
   switch$(%msg)
   {
      case "PASSWORD":
         ...
         return;
      case "CHR_PROTOCOL_SERVER":
         %error = "Incompatible protocol version: The server is running an older, incompatible version of Tribes 2.";
      case "CHR_PROTOCOL":
...
function clientCmdShowVehicleGauges(%vehType, %node)
{
   ...
   switch$ (%vehType) {
	...
	case "shrike2" :
         ...
         dashboardHud.add(dashboardHud.weapon);
         dashboardHud.weaponTwo = new GuiControl(vWeapHiliteTwo) {
            profile = "GuiDashBoxProfile";
            horizSizing = "right";
            vertSizing = "top";
            position = "202 22";
            ...
            new HudBitmapCtrl(vWeapBkgdTwo) {
               profile = "GuiDashBoxProfile";
               horizSizing = "right";
               vertSizing = "top";
               position = "0 0";
               extent = "82 40";
               minExtent = "8 8";
               bitmap = "gui/hud_veh_new_dashpiece_3";
               visible = "1";
               opacity = "0.8";

               new HudBitmapCtrl(vWeapIconTwo) {
                  profile = "GuiDashBoxProfile";
                  horizSizing = "right";
                  vertSizing = "top";
                  position = "28 6";
         ...
         dashboardHud.add(dashboardHud.weaponTwo);
         dashboardHud.weaponThree = new GuiControl(vWeapHiliteThree) {
            profile = "GuiDashBoxProfile";
            horizSizing = "right";
            vertSizing = "top";
            position = "202 22";
            ...
            new HudBitmapCtrl(vWeapBkgdThree) {
               profile = "GuiDashBoxProfile";
               horizSizing = "right";
               vertSizing = "top";
               position = "0 0";
               ...
               new HudBitmapCtrl(vWeapIconThree) {
                  profile = "GuiDashBoxProfile";
                  horizSizing = "right";
                  vertSizing = "top";
                  position = "28 6";
         ...
         dashboardHud.add(dashboardHud.weaponThree);
         $numVWeapons = 3;
...
function clientCmdMissionStartPhase2(%seq) {
	$ConstructionServerPretext	= "";
	$ConstructionServerVersion	= "";
	$ConstructionServerCredits	= "";
	$ConstructionServerQVer		= "";
	$ConstructionServerString	= "";
	commandToServer('ConstructionQueryServer');
	commandToServer('ConstructionRegisterClient',"2");
   // clean some stuff up.
   MessageHud.close();
   purgeResources();
...
function clientCmdQueryServerReply(%pretext,%version,%credits,%qVer) {
	$ConstructionServerPretext	= %pretext;
	$ConstructionServerVersion	= %version;
	$ConstructionServerCredits	= %credits;
	$ConstructionServerQVer		= %qVer;
	$ConstructionServerString	= %pretext SPC %version @ " - " @ %credits;
	echo($ConstructionServerString @ " - (" @ %qVer @ ")");
}
